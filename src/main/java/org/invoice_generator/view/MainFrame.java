    ...
    public void focusLost(FocusEvent e) {
        ...
        createBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                newInvoiceDialog = new NewInvoiceDialog(MainFrame.this, "Add new invoice", index);
                newInvoiceDialog.setVisible(true);

                if (newInvoiceDialog.invoiceData != null) {
                    ...
                    readInvFile.add(readInvFile.size(), newInvoiceDialog.invoiceData);
            ...
            } // end of create button action listener
        ...
        saveBtn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                newItemDialog = new NewItemDialog(MainFrame.this, "Add new item");
...
//                invTable.setRowSelectionInterval(selectedRow[0], selectedRow[0]);
                if (selectedItemRow > 0 && invItemsTable.getValueAt(0,0) !="") {
                    itemsAfterDelete = ActionsController.deleteItem(MainFrame.this, readItemsFile, selectedItemRow, selectedInvRow);
        cancelBtn.setEnabled(false);
                    ...
                    FileOperations.writeFiles(invTablePath, invTableItemsPath, readInvFile, itemsAfterDelete, MainFrame.this);
                    readItemsFile = FileOperations.readFile(new File(invTableItemsPath), MainFrame.this);
                    //readItemsFile = itemsAfterDelete;
                    ...
                    JOptionPane.showMessageDialog(MainFrame.this, "No row is selected! Please select one row", "Select row", JOptionPane.ERROR_MESSAGE);
                }
...
// end of delete --- in case the user click on delete button
    ...
    private void invItemsListener(final JTable itemsTable, final String[] itemData) {
        ...
        rowSelectionModel.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (selectedRow.length > 0) {
                    ...
                    String result1 = itemData[1], result2 = itemData[2], result3 = itemData[2];
